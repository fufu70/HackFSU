...
/**
 * This is the model class for table "tbl_log_type".
 *
 * The followings are the available columns in table 'tbl_log_type':
...
class LogType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('log_type', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('log_type_id, log_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'tblLogs' => array(self::HAS_MANY, 'TblLog', 'log_type_id'),
		);
	}
